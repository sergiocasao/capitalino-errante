...
include_once($_SERVER['DOCUMENT_ROOT'].'/wp-load.php' );
	...
	$plugin_master_version = constant('SPOTIFY_MASTER_VERSION');
	...
	if( is_multisite() ){
		...
		$license = get_blog_option($blog_id, 'spotify_license_key');
		$status = get_blog_option($blog_id, 'spotify_license_status' );
		$status_error = get_blog_option($blog_id, 'spotify_license_error' );
		$license_expires = get_blog_option($blog_id, 'spotify_license_expires' );
		...
		$license = get_option('spotify_license_key');
		$status = get_option( 'spotify_license_status' );
		$status_error = get_option( 'spotify_license_error' );
		$license_expires = get_option( 'spotify_license_expires' );

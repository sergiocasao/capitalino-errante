...
class spotify_master_admin_table_header extends WP_List_Table {
	/**
...
<table class="widefat" cellspacing="0">
	<thead>
		<tr>
			<th colspan="2"><h2><img src="<?php echo plugins_url('images/techgasp-minilogo-16.png', dirname(__FILE__)); ?>" style="float:left; height:18px; vertical-align:middle;" /><?php _e('&nbsp;About', 'spotify_master'); ?></h2></th>
		</tr>
	</thead>
	...
	<tbody>
		<tr class="alternate">
			<td><img src="<?php echo plugins_url('images/techgasp-spotifymaster-logo.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="387px" height="171px" style="padding:5px;"/></td>
			<td>

...
if ( is_admin() )
add_menu_page( 'Spotify Master', 'Spotify Master', 'manage_options', 'spotify-master', 'spotify_master_admin', plugins_url( 'spotify-master/images/techgasp-minilogo-16.png' ) );
}
		///////////////////////
		// WORDPRESS ACTIONS //
		///////////////////////
...
if(!class_exists('spotify_master_admin_table_header')){
	require_once( dirname( __FILE__ ) . '/spotify-master-admin-table-header.php');
}
...
if(!class_exists('spotify_master_admin_table_news')){
	require_once( dirname( __FILE__ ) . '/spotify-master-admin-table-news.php');
}
//Prepare Table of elements
...
<?php
if(!class_exists('spotify_master_admin_table_support')){
	require_once( dirname( __FILE__ ) . '/spotify-master-admin-table-support.php');
}
//Prepare Table of elements
$wp_list_table = new spotify_master_admin_table_support();
//Table of elements
$wp_list_table->display();

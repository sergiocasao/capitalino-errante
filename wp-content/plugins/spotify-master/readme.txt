...
1. Widget With Spotify Player (track) + Spotify Profile Button.
2. Widget With Spotify Player (Album) + Spotify Profile Button.
...
5. Spotify Play Widget. User Display.
6. Widget inside pages and posts. Shortcode framework implementation. Spotify Player + Profile Button inside a page.
7. Widget With Spotify Artist Discography.
8. Administrator Dashboard Widget.
...
= 5.0.6 =
* Adding slugs to shortcodes

= 5.0.5 =
* Fixing wpdb call when creating shortlinks inside posts and pages

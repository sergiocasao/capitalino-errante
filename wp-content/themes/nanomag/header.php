...
<html <?php language_attributes(); ?>>
	<head>
		...
		<?php  if (! is_404() ): ?>
			...
			<?php if( !empty($thumbnail_id) ): ?>
				<?php $thumbnail = wp_get_attachment_image_src( $thumbnail_id , '440x280' ); ?>
	...
	<?php  if(of_get_option('full_or_boxed_layout')!= 'full_image_option'): ?>
		<?php if(of_get_option('background_body_option')== 'big_image'): ?>
					...
					<div class="menu-primary-container main-menu">
						...
						<?php if(!of_get_option('disable_random_post_link')==1): ?>
							<div class="random_post_link">
								...
								<?php if( !empty( $random_post_header_link )): ?>

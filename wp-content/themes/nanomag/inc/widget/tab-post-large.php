...
/*-----------------------------------------------------------------------------------*/
    ...
    function __construct() {
        $widget_ops = array(
            'classname' => 'clearfix',
            'description' => esc_attr__('Display Hover large post in tab by select category work in menu and widget', 'jelly_text_main')
        );
        parent::__construct('tab-post-large-widget', esc_attr__('jellywp: Hover tab post large Widget', 'jelly_text_main'), $widget_ops);
    }

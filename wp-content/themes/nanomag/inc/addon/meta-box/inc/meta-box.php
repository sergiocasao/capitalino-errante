...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
				...
				echo '
					...
					if ( typeof rwmb == "undefined" )
					{
						var rwmb = {
							...
							summaryMessage : "' . esc_attr__( 'Please correct the errors highlighted below and try again.', 'rwmb' ) . '"
						};
					}
					else
					{
		...
		static function end_html( $html, $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . esc_attr__( '+', 'rwmb' ) . '</a>';
		...
		{
			$button = '<a href="#" class="rwmb-button button remove-clone">' . esc_attr__( '&#8211;', 'rwmb' ) . '</a>';

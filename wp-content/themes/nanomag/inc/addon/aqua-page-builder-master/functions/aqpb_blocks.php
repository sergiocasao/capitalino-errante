...
function aq_block_text($block) {
	...
	<p class="description">
		<label for="<?php echo esc_attr($block_id) ?>_text">
			Content
			<textarea id="<?php echo esc_attr($block_id) ?>_text" class="textarea-full" name="<?php echo esc_attr($block_saving_id) ?>[text]" rows="5"><?php echo esc_attr($text) ?></textarea>
		</label>
	</p>
	<?php
}
...
function aq_block_column($block) {
	...
	esc_attr__('Drag block items into this box', 'aqpb-l10n'),
	'</p>';

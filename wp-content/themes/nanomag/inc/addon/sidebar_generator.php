		...
		<div class="wrap">
			...
			<table class="widefat page" id="sbg_table" style="width:600px;">
				...
				<?php
					...
					?>
					<tr>
						<td colspan="3"><?php esc_attr_e('No Sidebars defined', 'jelly_text_main'); ?></td>
					</tr>
					<?php
				}
				?>
		...
		<div id="sbg_box" class="postbox " >
			...
			<div class="inside">
				<div class="sbg_container">
					...
					<p>
	<?php esc_attr_e('Select the custom sidebar, leave unselected to use the default sidebar', 'jelly_text_main'); ?>
					</p>
					<ul>
					<?php 

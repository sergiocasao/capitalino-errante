...
function cltvo_js(){
	...
	wp_register_style( 'cltvo_swiper_css', CSSPATH.'swiper.min.css', false, true );
	wp_register_script( 'cltvo_swiper_js', JSPATH.'swiper.jquery.min.js', array('jquery'), false, true );
	wp_enqueue_style('cltvo_swiper_css');

	wp_register_script( 'cltvo_functions_js', JSPATH.'functions-min.js', array('jquery', 'cltvo_swiper_js',/*'cltvo_scrollIt_js','cltvo_validate_js', 'cltvo_validate_espanol_js'*/), false, true );
...
function cltvo_admin_js(){
	wp_register_script( 'cltvo_admin_functions_js', JSPATH.'admin-functions-min.js', array('jquery'), false, false );
